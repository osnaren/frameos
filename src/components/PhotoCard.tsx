...
export default function PhotoCard({ photo, onClick }: PhotoCardProps) {
  ...
  return (
    <motion.div whileHover={{ y: -5 }} className="group relative cursor-pointer" onClick={onClick}>
      <div className="aspect-w-3 aspect-h-2 overflow-hidden rounded-lg bg-gray-100">
        ...
        <div className="bg-opacity-0 group-hover:bg-opacity-30 absolute inset-0 bg-black transition-opacity duration-200" />
      </div>
      <div className="mt-2">
